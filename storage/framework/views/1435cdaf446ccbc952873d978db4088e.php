                ...
                <div class="gap-4 flex justify-center items-center">
                    <span
                        ...
                        <div class="text-sm font-medium flex items-center gap-2">
                            ...
                            <p class="text-gray-900 dark:text-neutral-200"><?php echo e($totalPostCount); ?></p>
                        </div>
                    </span>
                    ...
                    <span
                        ...
                        <div class="font-medium flex items-center gap-2">
                            ...
                            <p class="text-gray-900 dark:text-neutral-200"><?php echo e($totalLikeCount); ?></p>
                        </div>
                    </span>
                </div>
                <!--[if BLOCK]><![endif]--><?php if(Auth::check() && $user->id === Auth::user()->id): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.btn-nav-link','data' => ['class' => 'py-2 px-4','href' => route('blog.manage')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'py-2 px-4','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('blog.manage'))]); ?>
