<div class="w-full px-4 py-4 gap-4 flex flex-col justify-start items-center mt-4">
    ...
    <header class="w-full gap-4 flex flex-col justify-center items-start">
        <div class="gap-2 flex flex-col justify-start items-start">
            ...
            <a href="<?php echo e(route('user.profile', ['username' => $post->user->username])); ?>"
                ...
                <img src="<?php echo e(asset($post->user->avatar)); ?>" alt="error" class="rounded-full w-6 h-6 bg-gray-400">
        ...
        <div class="gap-2 flex justify-start items-center">
            ...
            <time datetime="<?php echo e($isoTime); ?>" class="text-gray-600 dark:text-gray-400 text-sm">
                Last Updated: <?php echo e($updatedAt); ?>
    ...
    <figure class="w-full max-h-96 rounded-lg overflow-hidden flex flex-col justify-center items-center">
        <!--[if BLOCK]><![endif]--><?php if($post->cover_image): ?>
            ...
            <h4 class="mt-2 text-sm text-gray-600 dark:text-gray-400">Cover Image of <?php echo e($post->title); ?></h4>
        <?php else: ?>
