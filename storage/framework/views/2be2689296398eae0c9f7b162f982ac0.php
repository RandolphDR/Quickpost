...
<?php
    $classes = $active ?? false
        ? 'block w-full px-4 py-2 text-start text-sm leading-5 text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 focus:outline-none transition duration-150 ease-in-out'
