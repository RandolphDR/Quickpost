...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.btn-nav-link','data' => ['href' => route('admin.user.create'),'class' => 'py-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.user.create')),'class' => 'py-2']); ?>
                + Add New User
...
[$__name, $__params] = $__split('components.dashboard.users.all', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-4057255266-0', $__slots ?? [], get_defined_vars());
