<div class="gap-4 flex flex-col justify-center items-start">
    <header class="w-full gap-4 flex flex-col justify-center items-start">
        ...
        <p class="text-gray-700 dark:text-neutral-300 text-center w-full"><?php echo e($user->bio); ?></p>
        <hr class="w-full border-gray-400 dark:border-gray-600" />
    ...
    <main class="w-full text-sm text-gray-700 dark:text-neutral-300 gap-4 flex flex-col">
        <div class="gap-2 flex justify-start items-end">
            ...
            <p>
                Lives in <?php echo e($address['city']); ?>, <?php echo e($address['state']); ?>, <?php echo e($address['country']); ?>
        ...
        <div class="gap-2 flex justify-start items-end">
            ...
            <p>Born on <?php echo e($birthday); ?></p>
        </div>
        <div class="gap-2 flex justify-start items-end">
            <svg class="w-5 h-5 text-gray-900 dark:text-neutral-100" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <p>Joined <?php echo e($createdAt); ?></p>
        </div>
    </main>
</div>
<?php /**PATH C:\Users\Rando\Programming Workspaces\laravel-workspace\Quickpost\resources\views/livewire/pages/user/profile/stats.blade.php ENDPATH**/ ?>