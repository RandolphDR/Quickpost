    ...
    <main class="w-full overflow-x-auto py-2 flex flex-row justify-start items-center gap-4 scrollbar-custom">
        <article
            ...
            <figure class="w-full h-[50%] bg-slate-600 rounded-lg">
                <img src="<?php echo e(asset('images/technology-background.jpg')); ?>" alt="error" class="w-full h-full rounded-lg">
            </figure>
            <div class="w-full h-[50%] gap-2 flex flex-col justify-start items-start">
                <header class="w-full gap-2 flex justify-start items-center">
                    <span class="flex justify-center items-center gap-2">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">Randolph Saludo</p>
                    </span>
                    <p class="text-indigo-600 text-3xl">•</p>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">22 August 2004</p>
                </header>
                <main class="w-full gap-2 flex flex-col justify-start items-start">
                    <h1 class="text-xl font-semibold text-black dark:text-neutral-200">The Gods of Programming in 2025
                    </h1>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">
                        The year 2025 marked a pivotal moment in the history of technology. It was the year when
                        programming transcended its traditional boundaries, giving rise to what many now call the "Gods
                        of Programming."
                    </p>
                </main>
...
</div><?php /**PATH C:\Users\Rando\Programming Workspaces\laravel-workspace\Quickpost\resources\views\livewire/pages/blog/popular.blade.php ENDPATH**/ ?>