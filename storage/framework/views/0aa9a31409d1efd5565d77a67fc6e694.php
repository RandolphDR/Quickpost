<section class="w-full px-4 gap-4 flex flex-col justify-center items-center">
    <div class="w-full flex items-center gap-6 text-gray-400">
        <div class="flex items-center gap-2 hover:text-blue-500 transition-colors">
            <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox" id="like-checkbox" class="absolute opacity-0 h-0 w-0 peer">
                    <svg class="w-6 h-6 fill-current peer-checked:hidden" viewBox="0 0 512 512">
                        <path
                    ...
                    <svg class="w-6 h-6 fill-current text-[#1877F2] hidden peer-checked:block" viewBox="0 0 512 512">
                        <path
            ...
            <span class="text-sm"><?php echo e($post->likes->count()); ?> Likes</span>
        </div>
        ...
        <div class="cursor-pointer flex items-center gap-2">
            ...
            <span class="text-sm"><?php echo e($post->comments->count()); ?> Comments</span>
        </div>
    </div>
