...
<!--[if BLOCK]><![endif]--><?php if($messages): ?>
    <ul <?php echo e($attributes->merge(['class' => 'text-start text-sm text-red-600 dark:text-red-400 space-y-1'])); ?>>
...
<?php /**PATH C:\Users\Rando\Programming Workspaces\laravel-workspace\Quickpost\resources\views/components/input-error.blade.php ENDPATH**/ ?>