...
<?php $component->withAttributes([]); ?>
    ...
    <section id="privacy" class="w-full max-w-4xl px-4 py-10 mx-auto text-left flex flex-col gap-4">
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400 mt-4">Last updated: <?php echo e(now()->format('F d, Y')); ?></p>
    </section>
...
<?php endif; ?>
<?php /**PATH C:\Users\Rando\Programming Workspaces\laravel-workspace\Quickpost\resources\views/pages/contact.blade.php ENDPATH**/ ?>