            ...
            <div class="relative flex flex-col justify-center items-center gap-4 mt-20">
                <div class="flex flex-col justify-center items-center gap-2 relative">
                    ...
                    <span class="text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">{{ '@' . $user->username }}</p>
                    </span>
            ...
            <div class="w-full relative flex justify-between items-center p-4">
                ...
                @if (Gate::allows('user-access') && $user->id === auth()->user()->id)
                    <nav class="gap-4 flex justify-center items-center">
                        <a href="{{ route('user.settings') }}" class="py-2 px-4 inline-flex items-center gap-x-1 text-sm font-medium rounded-lg border border-transparent bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" wire:navigate>
                        ...
                        <a href="{{ route('user.settings') }}" class="py-2 px-4 inline-flex items-center gap-x-1 text-sm font-medium rounded-lg border border-transparent bg-gray-800 text-white hover:bg-gray-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" wire:navigate>
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
